...
![ESP32-S3-DevKitM-1 with ESP32-S3-MINI-1 Module](../../_images/esp32-s3-devkitm-1-v1-isometric.png)
...
![ESP32-S3-DevKitM-1 (click to enlarge)](../../_images/ESP32-S3-DevKitM-1_v1_SystemBlock.png)
...
The two tables below provide the **Name** and **Function** of the pins on both sides of the board (J1 and J3). The pin names are shown in ESP32-S3-DevKitM-1 - front. The numbering is the same as in the Board Schematic (PDF).
...
![ESP32-S3-DevKitM-1 (click to enlarge)](../../_images/ESP32-S3_DevKitM-1_pinlayout.jpg)
