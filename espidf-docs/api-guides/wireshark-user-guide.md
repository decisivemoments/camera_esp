...
![Wireshark Capture Interface](../_images/ws-capture-interface.jpeg)
...
![*Display Filter* Dialogue Box](../_images/ws-display-filter-dialogue-box.png)
...
![*Filter Expression* Dialogue Box](../_images/ws-filter-expression.png)
...
![Starting or Resuming Packets Capture](../_images/ws-start-resume-packet-capture.png)
...
![Saving Captured Packets](../_images/ws-save-packets.png)
